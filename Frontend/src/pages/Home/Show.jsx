...
const ShowListing = () => {
  ...
  useEffect(() => {
    ...
    console.log("listingData.owner:", listingData?.owner);
  }, [authUser, authError, authLoading, listingData]);

  if (authError)
    return <div className="text-center py-8 text-red-500">{authError}</div>;
  if (authLoading) return <div className="text-center py-8">Loading user...</div>;
