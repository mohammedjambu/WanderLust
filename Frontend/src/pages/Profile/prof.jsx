                ...
                {bookings.map((b) => (
                  <li key={b._id} className="data-list-item">
                    ...
                    <p className="data-list-item-subtitle">
                      ...
                      {new Date(b.checkOut).toLocaleDateString()} | {b.guests}{" "}
                      guests
                    </p>
                    <p className="data-list-item-details">
              ...
              <ul className="data-list">
                {reviews.map((r) => (
                  <li key={r._id} className="data-list-item">
                    <p className="data-list-item-title">
                      On: {r.listing?.title || "Deleted Listing"}
                    </p>
                    <p className="data-list-item-subtitle text-yellow-600">
                      Rating: {r.rating} ⭐
                    </p>
              ...
              <ul className="data-list">
                {listings.map((l) => (
                  <li key={l._id} className="data-list-item">
                    ...
                    <p className="data-list-item-subtitle">
                      {l.category} | ₹{l.price.toLocaleString("en-IN")} / night
                    </p>
                  </li>
                ))}
              </ul>
          ...
          <div className="tab-content">
            <div className="profile-header">
              ...
              <div className="complete-profile-card">
                ...
                <p>
                  Your Wanderlust profile is an important part of every
              ...
              <div className="flex flex-col items-center">
                <div className="relative">
                  <img
                    ...
                    alt="Avatar Preview"
                    className="w-24 h-24 rounded-full object-cover border-2 border-gray-300 text-center"
                  />
                  <label
              ...
              <div>
                ...
                <div className="phone-input-container">
                  <PhoneInput
                    id="phone"
                    international
                    defaultCountry="US" // Set a default country, e.g., United States
                    value={formData.phone}
                    onChange={(value) => handleFormChange("phone", value)}
                    className="form-input-style" // You can reuse your existing class for some base styles
                  />
                </div>
              </div>
