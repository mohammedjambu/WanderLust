    ...
    <div className="my-listing-card">
      ...
      <div className="my-listing-info-row">
        <div className="my-listing-body">
          <p className="my-listing-title" title={listing.title}>
            {listing.title}
          </p>
...
const SkeletonMyListingCard = () => (
  <div className="my-listing-card skeleton-my-listing-card">
    <div className="my-listing-image-container"></div>
    <div className="my-listing-info-row">
...
const MyListings = () => {
  ...
  const handleDelete = async (listingId) => {
    if (
      ...
      try {
        await axios.delete(`${serverUrl}/api/listings/${listingId}`, {
          withCredentials: true,
        });
        setListings((prevListings) =>
          prevListings.filter((l) => l._id !== listingId)
        );
    ...
    if (listings.length === 0) {
      return (
        <div className="status-container">
          ...
          <Link to="/createListing1" className="action-btn-new">
  ...
  return (
    <main className="my-listings-container">
      ...
      <div className="my-listings-grid">{renderContent()}</div>
    </main>
  );
};
